<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="110px">
      ...
      <!-- <el-form-item label="业务原价" prop="oldPrice">
        <el-input
      ...
      <!-- <el-form-item label="计量单位类型" prop="businessUnit" >
        <el-select v-model="queryParams.businessUnit" placeholder="计量单位类型:1天,2月,3次" style="width:100%">
          <el-option
     ...
     <!-- <el-form-item label="月数" prop="monthNumber">
      ...
      <el-form-item label="次数" prop="timesNumber">
        <el-input
          v-model="queryParams.timesNumber"
          placeholder="请输入次数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <!-- <el-form-item label="生效时间类型" prop="timeType">
        <el-select v-model="queryParams.timeType" placeholder="生效时间类型:1固定起止时间,2,购买后生效3,购买n天后生效" style="width:100%">
          <el-option
      ...
      <!-- <el-form-item label="延迟生效天数" prop="delayDays">
        <el-input
          v-model="queryParams.delayDays"
          placeholder="请输入延迟生效天数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
