  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="对接手机号码" prop="salesmanPhone">
        <el-input
          v-model="queryParams.salesmanPhone"
    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否上下架" align="center" prop="standUp" :formatter="standUpFormat" />
...
<script>
import { listActivity, getActivity, delActivity, addActivity, updateActivity, exportActivity,getCardbg } from "@/api/share/activity";
