...
<!--      <el-table-column label="主键ID" align="center" prop="id" />-->
     ...
     <el-table-column label="谈单员" align="center" prop="counselorName" min-width="120"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" min-width="220">
        <template slot-scope="scope">
          ...
          >删除</el-button> -->
         <!-- <el-button
            v-if="deptId == 151 && scope.row.open == 10"
            size="mini"
            type="text"
          ...
          >订单业务完成</el-button>-->
          <el-button
            v-if="scope.row.salesmanDisposeStatus==2&&scope.row.userDisposeStatus==2"
             size="mini"
             type="text"
             icon="el-icon-circle-check"
             @click="handleProfitr(scope.row)"
           >分润详情</el-button>
          <el-button
             size="mini"
             type="text"
             icon="el-icon-circle-check"
             @click="handleCounselor(scope.row)"
           >指派谈单员</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <!-- 指派谈单员 -->
    <el-dialog :title="title" :visible.sync="counselorOpen" width="600px" append-to-body :close-on-click-modal="false" >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="24">
            <el-col :span="24">
              <el-form-item label="谈单员" prop="userId" >
                <el-select v-model="form.userId" placeholder="请选择谈单员"  style="width: 100%" >
                  <el-option
                    v-for="item in counselorOtion"
                    :key="item.userId"
                    :label="item.nickName"
                    :value="item.userId"
                  >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitSalesman">确 定</el-button>
        <el-button @click="cancel">取 消</el-button>
      </div>
    </el-dialog>
...
<!--        </el-form-item>-->
    ...
    <!-- 查看分润详情 -->
    <el-dialog :title="title" :visible.sync="profitrOpen" width="1200px" append-to-body :close-on-click-modal="false" >
      <el-form  :model="profitrOption"  label-width="160px">
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="完成人姓名:"  prop="finishUserName">
              <span>{{profitrOption.finishUserName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="完成人角色名称:"  prop="finishUserRoleName">
              <span>{{profitrOption.finishUserRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="完成人分成比例:"  prop="finishUserProportion">
              <span>{{profitrOption.finishUserProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="完成人分成金额:"  prop="finishUserMoney">
              <span>{{profitrOption.finishUserMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="上级姓名:"  prop="upUserName">
              <span>{{profitrOption.upUserName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级角色名称:"  prop="upUserRoleName">
              <span>{{profitrOption.upUserRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级分成比例:"  prop="upUserProportion">
              <span>{{profitrOption.upUserProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级分成金额:"  prop="upUserMoney">
              <span>{{profitrOption.upUserMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="上上级姓名:"  prop="up2UserName">
              <span>{{profitrOption.up2UserName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级角色名称:"  prop="up2UserRoleName">
              <span>{{profitrOption.up2UserRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级分成比例:"  prop="up2UserProportion">
              <span>{{profitrOption.up2UserProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级分成金额:"  prop="up2UserMoney">
              <span>{{profitrOption.up2UserMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="业务员姓名:"  prop="salesmanName">
              <span>{{profitrOption.salesmanName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="业务员角色名称:"  prop="salesmanRoleName">
              <span>{{profitrOption.salesmanRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="业务员提成比例:"  prop="salesmanProportion">
              <span>{{profitrOption.salesmanProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="业务员提成金额:"  prop="salesmanMoney">
              <span>{{profitrOption.salesmanMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="代理商姓名:"  prop="agentName">
              <span>{{profitrOption.agentName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="代理商角色名称:"  prop="agentRoleName">
              <span>{{profitrOption.agentRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="代理商奖励比例:"  prop="agentAwardProportion">
              <span>{{profitrOption.agentAwardProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="代理商奖励金额:"  prop="agentAwardMoney">
              <span>{{profitrOption.agentAwardMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="上级代理商姓名:"  prop="upAgentName">
              <span>{{profitrOption.upAgentName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级代理商角色名称:"  prop="upAgentRoleName">
              <span>{{profitrOption.upAgentRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级代理商奖励比例:"  prop="upAgentProportion">
              <span>{{profitrOption.upAgentProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上级代理商分成金额:"  prop="upAgentMoney">
              <span>{{profitrOption.upAgentMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="上上级代理商姓名:"  prop="upAgentName">
              <span>{{profitrOption.upAgentName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级代理商角色名称:"  prop="up2AgentRoleName">
              <span>{{profitrOption.up2AgentRoleName}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级代理商分成比例:"  prop="up2AgentProportion">
              <span>{{profitrOption.up2AgentProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="上上级代理商奖励金额:"  prop="up2AgentMoney">
              <span>{{profitrOption.up2AgentMoney}}</span>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="24">
          <el-col :span="6">
            <el-form-item label="成本比例:"  prop="costProportion">
              <span>{{profitrOption.costProportion}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="成本金额:"  prop="costMoney">
              <span>{{profitrOption.costMoney}}</span>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="支出金额:"  prop="paidAmount">
              <span>{{profitrOption.paidAmount}}</span>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import {
  ...
  assignCounselorPost,
  AgentOrderDetail
 } from "@/api/share/threeAgent/order";
import {
  getSourceAgent,
  getUserlist
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userId:[{required: true, message: '请选择谈单员', trigger: 'change'}]
  ...
  methods: {
    ...
    cancel() {
      ...
      this.counselorOpen = false
      this.profitrOpen = false
    },
    // 表单重置
    reset() {
      this.form = {
...
// 流转外勤办事员弹窗
    ...
    handleCounselor(row){
      console.log(row)
      this.form.id = row.id
      this.counselorOpen = true
      getuserList({}).then(res=>{
        // console.log(res.rows)
        if(res.code==200){
          this.counselorOtion = res.rows;
        }
      })
    },
    // 提交谈单员
    submitSalesman(){
      ...
      this.$refs['form'].validate(valid => {
        if (valid){
          assignCounselorPost(data).then(res=>{
            console.log(res)
            if (res.code === 200) {
              this.msgSuccess("提交成功");
              this.counselorOpen = false;
    ...
    // 分润详情
    handleProfitr(row){
      this.profitrOpen = true
      AgentOrderDetail(row.id).then(res=>{
        // console.log(res)
        if(res.code==200){
          if(res.data){
            this.profitrOption = res.data
          }
        }
      })
    },
