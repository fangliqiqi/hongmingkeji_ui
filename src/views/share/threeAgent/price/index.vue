...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="AgentBusinessTypeList" @selection-change="handleSelectionChange">
<!--      <el-table-column type="selection" width="55" align="center" />-->
<!--      <el-table-column label="主键id" align="center" prop="id" />-->
      <el-table-column label="业务名称" align="center" prop="name" />
      <el-table-column label="指导价格" align="center" prop="guidePrice" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listAgentBusinessType(this.queryParams).then(response => {
          this.AgentBusinessTypeList = response.rows;
