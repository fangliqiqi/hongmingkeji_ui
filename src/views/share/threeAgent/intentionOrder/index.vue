<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="agentIntentionOrderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="谈单员" align="center" prop="counselorName" min-width="100"/>
...
import {
  ...
  getuserList,
  assignCounselorPost
  } from "@/api/share/threeAgent/intentionOrder";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userId:[{ required: true, message: '请选择谈单员', trigger: 'blur' }]
      }
    };
  },
  created() {
