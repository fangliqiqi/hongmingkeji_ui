      ...
      <div class="follow-div">
        ...
        >
          ...
          <div>
            ...
            <span style=" float: left;margin-left:0;">下次跟进时间：{{item.bcfollow_time, "yyyy-MM-dd " | format}}  <span style="margin-left:340px">{{ item.create_time, "yyyy-MM-dd hh:mm:ss" | format }}</span> </span>
